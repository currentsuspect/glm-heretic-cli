...
from glm_runtime import detect_gpu_layers
...
def handoff(args):
    if not args:
        os.execvp("python3", ["python3", "/home/jovyan/glm_chat.py"])

    mode = args[0]
    if mode == "--agent":
        os.execvp("python3", ["python3", "/home/jovyan/glm_agent.py", *args[1:]])
    if mode == "--serve":
        os.execvp("python3", ["python3", "/home/jovyan/glm_server.py", *args[1:]])
    os.execvp("python3", ["python3", "/home/jovyan/glm_chat.py", *args])
